...
public class ViewerPreviewWidget extends PopupPanel implements ClickHandler {
	private static final String EMAIL_TEXT = "Check out this Presentation %1% on Rise Vision - a web platform for digital signage - %2%";
...
//			}
				...
				Window.open("mailto:?subject=Rise Vision Presentation&body=" + messageString, "_blank", "");
			}
			...
			Window.open("http://www.risevision.com", "_blank", "");
		}
	}
